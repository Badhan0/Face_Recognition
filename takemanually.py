    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "/home/badhan/Downloads/Automatic-Attendance-System--main/Attendance(Manually)/"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"/home/badhan/Downloads/Automatic-Attendance-System--main/Attendance(Manually)"'
                )
